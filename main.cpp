...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Digibyte-seeder\n"
...
static const string mainnet_seeds[] = {"digibytewiki.com", "digiexplorer.info", "digihash.co", ""};
static const string testnet_seeds[] = {"testnet-seed.litecointools.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 14022), true);
  }
  do {
